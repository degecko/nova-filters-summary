  ...
  methods: {
      ...
      this.activeFilters = _.cloneDeep(filters).filter(function (filter) {
        ...
        if (Nova.filtersSummaryResolvers[filter.component]) {
          ...
          filter.options.map(function (o) {
            return map[_this2.nin(o.value)] = o.name;
          });
    ...
    del: function del(filter) {
      ...
      this.$nextTick(function () {
        ...
        var activeFilters = _this3.activeFilters.filter(function (f) {
        ...
        _this3.$router.push({
          query: _.defaults((_$defaults = {}, _defineProperty(_$defaults, "".concat(_this3.resourceName, "_page"), 1), _defineProperty(_$defaults, "".concat(_this3.resourceName, "_filter"), btoa(JSON.stringify(activeFilters))), _$defaults), _this3.$root.$route.query)
        });
      });
    }
  },
...
var _hoisted_2 = {
  "class": "flex align-items-center mb-3 font-normal"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["fsc-filter flex bg-white shadow px-1 py-1 mr-2 mb-2", $props.card.stacked ? 'rounded' : 'rounded-full align-items-center']),
      key: filter
    }, [$props.card.stacked ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.name), 1
    /* TEXT */
    ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      innerHTML: filter.currentValue
    }, null, 8
    /* PROPS */
    ...
    /* STABLE_FRAGMENT */
      ...
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["remove-filter flex align-items-center justify-center font-bold bg-40 cursor-pointer hover:text-white hover:bg-90", $props.card.stacked ? 'rounded' : 'rounded-full']),
...
/* harmony import */ var D_Code_erp_nova_upgrade_erp_local_nova_filters_summary_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,D_Code_erp_nova_upgrade_erp_local_nova_filters_summary_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_FiltersSummary_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_FiltersSummary_vue_vue_type_template_id_26a41fc9__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/FiltersSummary.vue"]])
/* hot reload */
if (false) {}
